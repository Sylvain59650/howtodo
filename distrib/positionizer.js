...
(function(moduleName, root, factory) {
  ...
  Positionizer.getAttach = function(el, placement, spacings) {
    const x = parseFloat(el.offsetLeft);
    const y = parseFloat(el.offsetTop);
  ...
  Positionizer.getRelativePosition = function(fixedEl, floatingEl, placement, appendToBody, distX, distY) {
    const fixedElPos = appendToBody ? getOffset(fixedEl, false) : Positionizer.getPosition(fixedEl, false);
