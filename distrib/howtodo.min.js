'use strict';var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};function format(){var s=arguments[0];for(var i=0;i<arguments.length-1;i++){var reg=new RegExp("\\{"+i+"\\}","gm");s=s.replace(reg,arguments[i+1]);}return s;};HTMLElement.prototype.addClass=function(className){this.setAttribute("class",this.getAttribute("class")+" "+className);return this;};HTMLElement.prototype.removeClass=function(className){var cl=this.getAttribute("class")||"";cl=cl.replace(className,"");this.setAttribute("class",cl);return this;};HTMLElement.prototype.css=function(cssProperty,cssValue){var s=this.style;if((typeof cssProperty==="undefined"?"undefined":_typeof(cssProperty))==="object"){for(var p in cssProperty){s[p]=cssProperty[p];}}else{this.style[cssProperty]=cssValue;}return this;};HTMLElement.prototype.appendTo=function(html){this.insertAdjacentHTML("beforeend",html);return this;};HTMLElement.prototype.outerHeight=function(){return this.parentElement?this.parentElement.clientHeight:0;};HTMLElement.prototype.outerWidth=function(){return this.parentElement?this.parentElement.clientWidth:0;};HTMLElement.prototype.offset=function(){return{top:this.offsetLeft,left:this.offsetTop};};HTMLElement.prototype.on=function(evtName,fn){console.log("on",this,evtName);this.addEventListener(evtName,fn);};var Guide=function Guide(guide,$container,options){debugger;this.guide=guide;this._distance=guide.distance||options.distance;this._color=guide.color||options.color;this._class=guide.cssClass||options.cssClass||'';this.$highlightedElement=guide.element.addClass('guides-current-element');this.$container=$container;this.init();};Guide.prototype._arrowSize=10;// Mx1,y1, Cdx1,dy1,dx2,dy2,x2,y2
// (x1,y1) - start point
// (dx1,dy1) - curve control point 1
// (dx2,dy2) - curve control point 2
// (x2,y2) - end point
Guide.prototype._path='M{0},{1} C{2},{3},{4},{5},{6},{7}';Guide.prototype._arrowTemplate='<svg width="{0}" height="{1}">\
    <defs>\
