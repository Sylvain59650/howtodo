...
HTMLElement.prototype.off = function(eventName, eventHandler) {
  if (eventHandler == undefined) {
    console.warn("off:No listener defined to remove with event " + eventName);
  }
...
HTMLElement.prototype.emit = function(eventName, details) {
...
function newElement(tagName, attributes, htmlContent, events) {
  ...
  if (events) {
    for (var ev in events) {
      ...
      tag.addEventListener("click", events[ev]);
    }
